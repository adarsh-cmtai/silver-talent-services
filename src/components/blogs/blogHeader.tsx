                ...
                <div className="flex flex-col md:flex-row items-center md:gap-8">
                    ...
                    <div className="md:w-5/12 lg:w-2/5 text-center md:text-left mb-12 md:mb-0">
                        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-medium text-gray-900 mb-6 animate-on-scroll">
                            Blogs <span className="font-bold"></span>
                        </h1>
                        <p className="text-base sm:text-lg text-gray-600 mb-8 animate-on-scroll leading-relaxed">
                            Finding the perfect fit for your organization doesn’t have to be difficult. Get in touch with us to explore how we can partner together to meet your hiring goals. Whether you have a pressing requirement or are simply planning ahead, our recruitment experts are ready to deliver fast, high-quality solutions tailored to your needs.
                        </p>
                        <p>
                            We welcome you to share any current hiring challenges — our team is confident you’ll be impressed by both our speed and our precision in matching talent with opportunity.
                        </p>
