...
//   ChevronDown,    // For Read More icon
//   ChevronUp       // For Read Less icon
// } from 'lucide-react';
...
//               <Card
//                 key={index}
//                 className="animate-on-scroll bg-white shadow-2xl border-gray-400 rounded-xl overflow-hidden" // Clear white, shadow, rounded
...
//                       className="text-sky-600 hover:text-sky-700 font-semibold text-sm md:text-base"
//                     >
